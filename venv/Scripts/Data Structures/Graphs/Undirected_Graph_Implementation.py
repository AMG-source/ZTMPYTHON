...
#There are many many applications of graphs and many operations can be performed on them.
...
#Adjacency matrix is a nXn matrix where n is the number of nodes. M[i][j] = 1 if nodes i and j are connected otherwise 0
